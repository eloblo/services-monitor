...
class Monitor:
    ...
    def ListServices(self):
        ...
        # get all the services from the terminal and create a list
        terminal = subprocess.run(["service", "--status-all"], stdout=subprocess.PIPE, text=True)
        services = terminal.stdout.split('\n')
        services.pop()
